...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://a1603169:wytmekd9857qwer!@cluster0.23wckut.mongodb.net/?retryWrites=true&w=majority");
  const db = client.db();
